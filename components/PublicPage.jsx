...
const THEMES = {
  ...
  'aurora-mint':   {'--bg':'#061614','--text':'#eafff7','--muted':'#b4f2e1','--border':'#174a3f','--card-bg-1':'#0c2b24','--card-bg-2':'#081e19','--chip-bg':'#0a241f','--chip-border':'#1b5b4c','--btn-primary-1':'#3be6a5','--btn-primary-2':'#6ad3ff','--btn-neutral-bg':'#10221d','--social-border':'#236456'},
  'sunset-coral':  {'--bg':'#140a0a','--text':'#ffeceb','--muted':'#ffc9c2','--border':'#55312e','--card-bg-1':'#2b1513','--card-bg-2':'#1e0f0e','--chip-bg':'#231312','--chip-border':'#6a3a35','--btn-primary-1':'#ff8a65','--btn-primary-2':'#ffbf6b','--btn-neutral-bg':'#1b1514','--social-border':'#6b3d36'},
  'ocean-glass':   {'--bg':'#05121a','--text':'#e6f7ff','--muted':'#c3e7ff','--border':'#174a68','--card-bg-1':'#0b2740','--card-bg-2':'#081a2b','--chip-bg':'#0a2435','--chip-border':'#1d4f78','--btn-primary-1':'#64d1ff','--btn-primary-2':'#5ff7c2','--btn-neutral-bg':'#0f1e28','--social-border':'#1f4d73'},
  'rose-gold':     {'--bg':'#fbf6f4','--text':'#261a17','--muted':'#7a645d','--border':'#ead7cf','--card-bg-1':'#ffffff','--card-bg-2':'#f8eeeb','--chip-bg':'#f3e8e4','--chip-border':'#ead7cf','--btn-primary-1':'#f7a8a8','--btn-primary-2':'#ffcf7a','--btn-neutral-bg':'#efe3de','--social-border':'#e3cfc6'},
  'neon-plum':     {'--bg':'#100616','--text':'#f3eaff','--muted':'#d0b7ff','--border':'#3f2a6b','--card-bg-1':'#1b0f34','--card-bg-2':'#140a27','--chip-bg':'#160d2f','--chip-border':'#4a3687','--btn-primary-1':'#a77bff','--btn-primary-2':'#ff7fe1','--btn-neutral-bg':'#1f173b','--social-border':'#42307a'},
  'solar-sand':    {'--bg':'#faf6ee','--text':'#221f19','--muted':'#7b7166','--border':'#e7dcc8','--card-bg-1':'#ffffff','--card-bg-2':'#f5efe3','--chip-bg':'#f2ebde','--chip-border':'#e7dcc8','--btn-primary-1':'#f7b267','--btn-primary-2':'#7cd0ff','--btn-neutral-bg':'#efe9db','--social-border':'#e0d6c2'},
  'arctic-sky':    {'--bg':'#f6fbff','--text':'#101418','--muted':'#576a7b','--border':'#d9e6f2','--card-bg-1':'#ffffff','--card-bg-2':'#eef6fd','--chip-bg':'#eef4fb','--chip-border':'#d9e6f2','--btn-primary-1':'#62a8ff','--btn-primary-2':'#3fe3a1','--btn-neutral-bg':'#eaf2f9','--social-border':'#d1e1ef'},
  'jade-noir':     {'--bg':'#060d0a','--text':'#e9fff7','--muted':'#bde9d8','--border':'#1b4032','--card-bg-1':'#0c231b','--card-bg-2':'#081712','--chip-bg':'#0a1e17','--chip-border':'#205944','--btn-primary-1':'#2fe399','--btn-primary-2':'#77d2ff','--btn-neutral-bg':'#0e1a14','--social-border':'#1f5743'},
  'copper-ink':    {'--bg':'#0e0b09','--text':'#f6efe9','--muted':'#e0c9b8','--border':'#493a2f','--card-bg-1':'#1a1410','--card-bg-2':'#12100d','--chip-bg':'#16120f','--chip-border':'#5d4a3c','--btn-primary-1':'#ffb066','--btn-primary-2':'#ff7a66','--btn-neutral-bg':'#1b1713','--social-border':'#5a4a3d'},
  'pearl-mist':    {'--bg':'#fffefd','--text':'#111213','--muted':'#5e636a','--border':'#ebe7e0','--card-bg-1':'#ffffff','--card-bg-2':'#faf7f0','--chip-bg':'#f6f3ee','--chip-border':'#ebe7e0','--btn-primary-1':'#111827','--btn-primary-2':'#8792a2','--btn-neutral-bg':'#f1ede6','--social-border':'#e6e0d8'},
  'emerald-flare': {'--bg':'#07120f','--text':'#eafff6','--muted':'#bff0df','--border':'#1a4a3b','--card-bg-1':'#0b261f','--card-bg-2':'#081a15','--chip-bg':'#0a201a','--chip-border':'#215e4a','--btn-primary-1':'#33e6a1','--btn-primary-2':'#7be3ff','--btn-neutral-bg':'#0f1f1a','--social-border':'#236853'}

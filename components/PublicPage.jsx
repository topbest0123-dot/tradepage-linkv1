...
const THEMES = {
  ...
  'cyber-night':    {'--bg':'#07080d','--text':'#eaf7ff','--muted':'#a8d8ff','--border':'#1e2a46','--card-bg-1':'#0d1626','--card-bg-2':'#090f1a','--chip-bg':'#0b1320','--chip-border':'#2a3e6e','--btn-primary-1':'#44e6ff','--btn-primary-2':'#ff79c6','--btn-neutral-bg':'#121826','--social-border':'#2b3f6f'},
  ...
  'blush-sky':      {'--bg':'#fff7f9','--text':'#201416','--muted':'#85636c','--border':'#f0d1da','--card-bg-1':'#ffffff','--card-bg-2':'#fbeef2','--chip-bg':'#f6e6eb','--chip-border':'#f0d1da','--btn-primary-1':'#ff7aa2','--btn-primary-2':'#7acbff','--btn-neutral-bg':'#f3e6ea','--social-border':'#ead0da'},
  'mono-ice':       {'--bg':'#fdfefe','--text':'#101213','--muted':'#5b6166','--border':'#e6ecef','--card-bg-1':'#ffffff','--card-bg-2':'#f6fafc','--chip-bg':'#f1f6f9','--chip-border':'#e6ecef','--btn-primary-1':'#0f172a','--btn-primary-2':'#8ab4ff','--btn-neutral-bg':'#eef3f7','--social-border':'#dde6ee'},
  'aurora-dawn':     {'--bg':'#0a0d13','--text':'#eef7ff','--muted':'#b9d6ff','--border':'#1b2a46','--card-bg-1':'#101a2a','--card-bg-2':'#0b1220','--chip-bg':'#0d1728','--chip-border':'#22375b','--btn-primary-1':'#6ee7f8','--btn-primary-2':'#a78bfa','--btn-neutral-bg':'#152436','--social-border':'#26436d'},
  ...
  'velvet-burgundy': {'--bg':'#130a0d','--text':'#feeef4','--muted':'#f7c6d8','--border':'#3b1c26','--card-bg-1':'#220f16','--card-bg-2':'#170a10','--chip-bg':'#1d0e14','--chip-border':'#4a2030','--btn-primary-1':'#ff7aa2','--btn-primary-2':'#c084fc','--btn-neutral-bg':'#231118','--social-border':'#512336'},

...
<style>{  :root { background: var(--bg); color: var(--text); }   html,body { background: var(--bg); color: var(--text); }   @media (max-width:480px){   .hdr-name{ font-size:16px; line-height:20px; }   .hdr-sub{ font-size:12px; }   .hdr-cta a, .hdr-cta button{ padding:6px 10px; border-radius:10px; font-size:12px; }   .hdr-cta{ gap:8px; }   }  }</style>

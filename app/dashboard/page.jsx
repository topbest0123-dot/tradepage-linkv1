...
const THEMES = {
  ...
  'cyber-night':    { name:'Cyber Night', vars:{'--bg':'#07080d','--text':'#eaf7ff','--muted':'#a8d8ff','--border':'#1e2a46','--card-bg-1':'#0d1626','--card-bg-2':'#090f1a','--chip-bg':'#0b1320','--chip-border':'#2a3e6e','--btn-primary-1':'#44e6ff','--btn-primary-2':'#ff79c6','--btn-neutral-bg':'#121826','--social-border':'#2b3f6f'}},
  ...
  'aurora-dawn':     { name:'Aurora Dawn',     vars:{'--bg':'#0a0d13','--text':'#eef7ff','--muted':'#b9d6ff','--border':'#1b2a46','--card-bg-1':'#101a2a','--card-bg-2':'#0b1220','--chip-bg':'#0d1728','--chip-border':'#22375b','--btn-primary-1':'#6ee7f8','--btn-primary-2':'#a78bfa','--btn-neutral-bg':'#152436','--social-border':'#26436d'}},
  ...
  'velvet-burgundy': { name:'Velvet Burgundy',vars:{'--bg':'#130a0d','--text':'#feeef4','--muted':'#f7c6d8','--border':'#3b1c26','--card-bg-1':'#220f16','--card-bg-2':'#170a10','--chip-bg':'#1d0e14','--chip-border':'#4a2030','--btn-primary-1':'#ff7aa2','--btn-primary-2':'#c084fc','--btn-neutral-bg':'#231118','--social-border':'#512336'}},

...
const THEMES = {
  ...
  'aurora-mist':    {name:'Aurora Mist',vars:{'--bg':'#f4fbff','--text':'#0e1418','--muted':'#4c6272','--border':'#cfe0ea','--card-bg-1':'#e2edf5','--card-bg-2':'#dbe7f1','--chip-bg':'#eaf2f8','--chip-border':'#cfe0ea','--btn-primary-1':'#22c55e','--btn-primary-2':'#3b82f6','--btn-neutral-bg':'#e8f1f6','--social-border':'#c9dae5'}},'honey-slate':{name:'Honey Slate',vars:{'--bg':'#fff7e8','--text':'#1a1410','--muted':'#6b5a46','--border':'#e8d6b8','--card-bg-1':'#f0e4cf','--card-bg-2':'#ead9c3','--chip-bg':'#f4e9d6','--chip-border':'#e6d2b3','--btn-primary-1':'#f59e0b','--btn-primary-2':'#10b981','--btn-neutral-bg':'#efe3cf','--social-border':'#e1ceb0'}},
